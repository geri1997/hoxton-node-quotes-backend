...
var PORT = process.env.PORT || 3009; // ky kodi shtese asht per heroku
//static web server
...
app.get("/headlines", function (req, res) {
    ...
    axios
        ...
        .then(function (resp) {
        var html = resp.data; //res.data asht krejt html e njasaj url
        ...
        $('a:contains("climate")', html).each(function () {
            ...
            headlines.push({ title: title, url: url });
...
app.listen(PORT, function () {
    return console.log("Server.ts started on port ".concat(PORT));
});
// app.use(
//   cors({
//     origin: "*",
